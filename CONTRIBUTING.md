...
10. All changes to snekbox **must be validated against the bot** before PRing. Please don't leave this for reviewers to discover. Guides for setting up the developer environments can be [found below](#developer-environment).
